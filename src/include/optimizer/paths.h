...
typedef enum GooGreedyStrategy
{
	...
	GOO_GREEDY_STRATEGY_HYBRID
}			GooGreedyStrategy;

/* Prototype default for the hybrid search exact-DP prefix depth. */
#define DEFAULT_GOO_HYBRID_EXACT_LEVEL 5
...
extern PGDLLIMPORT int goo_hybrid_exact_level;
